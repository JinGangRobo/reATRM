...
private:
  ...
  void declareParameters()
  {
    ...
    // status = MV_CC_SetEnumValueByString(camera_handle_, "PixelFormat", "RGB8Packed");
    // if (status == MV_OK) {
    ...
    frame_id_ = this->declare_parameter("frame_id", "industrial_camera_optical_frame");
    camera_topic_ = this->declare_parameter("camera_topic", "image_raw");
