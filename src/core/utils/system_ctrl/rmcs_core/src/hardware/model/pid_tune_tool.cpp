...
private:
    ...
    public:
        ...
        explicit TopBoard(
            ...
            pid_tune_tool.register_output("/top/imu/gz", imu_gz);
            pid_tune_tool.register_output("/top/imu/gy", imu_gy);
        }
    ...
    public:
        ...
        explicit BottomBoard(
            ...
            pid_tune_tool.register_output("/bottom/imu/gz", imu_gz);
            pid_tune_tool.register_output("/bottom/imu/gy", imu_gy);
