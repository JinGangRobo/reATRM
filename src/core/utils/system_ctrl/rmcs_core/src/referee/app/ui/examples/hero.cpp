...
public:
    Hero()
        ...
        register_input(
            "/gimbal/first_left_friction/control_velocity", first_friction_control_velocity_);
        register_input("/gimbal/first_left_friction/velocity", first_friction_velocity_);
...
private:
    ...
    void update_normal_ui() {
        ...
        status_ring_.update_friction_wheel_speed(
            std::min(*first_friction_velocity_, *right_friction_velocity_),
